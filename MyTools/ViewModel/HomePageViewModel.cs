...
namespace MyTools.ViewModel
{
    public class HomePageViewModel : BaseViewModel
    {
        ...
        public ICommand OpenMoFishRiBao => new MyCommand(o =>
        {
            Dialog.Show(new ImgMiniControl("https://dayu.qqsuu.cn/moyuribao/apis.php"));
        });
        public ICommand OpenMoFishRiLi => new MyCommand(o =>
        {
            Dialog.Show(new ImgMiniControl("https://dayu.qqsuu.cn/moyurili/apis.php"));
        });
        public ICommand OpenMoFishMingXingBaGua => new MyCommand(o =>
        {
            Dialog.Show(new ImgMiniControl("https://dayu.qqsuu.cn/mingxingbagua/apis.php"));
        });
